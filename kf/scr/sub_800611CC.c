...
{
    int* a1 = (int*)GET_PTR(ctx->r4);
    uint16_t* a2 = (uint16_t*)GET_PTR(ctx->r5);
    int* a3 = (int*)GET_PTR(ctx->r6);
    ...
    // Вектор 0
    ctx->cp2d[0] = (uint32_t)a2[0] | ((uint32_t) * (uint32_t*)(a2 + 1) & 0xFFFF0000);
    ctx->cp2d[1] = *(uint32_t*)(a2 + 3);
    ctx_to_gte(ctx);
    GTE_operator(0x486012);
    gte_to_ctx(ctx);
    int r9_0 = (int32_t)ctx->cp2d[9];
    int r10_0 = (int32_t)ctx->cp2d[10];
    int r11_0 = (int32_t)ctx->cp2d[11];

    // Вектор 1
    ctx->cp2d[0] = (uint32_t)a2[1] | ((uint32_t) * (uint32_t*)(a2 + 2) << 16);
    ctx->cp2d[1] = a2[7];
    ctx_to_gte(ctx);
    GTE_operator(0x486012);
    gte_to_ctx(ctx);
    int r9_1 = (int32_t)ctx->cp2d[9];
    int r10_1 = (int32_t)ctx->cp2d[10];
    int r11_1 = (int32_t)ctx->cp2d[11];

    // Вектор 2
    ctx->cp2d[0] = (uint32_t)a2[2] | ((uint32_t) * (uint32_t*)(a2 + 2) & 0xFFFF0000);
    ctx->cp2d[1] = *(uint32_t*)(a2 + 4);
    ctx_to_gte(ctx);
    GTE_operator(0x486012);
    gte_to_ctx(ctx);
    int r9_2 = (int32_t)ctx->cp2d[9];
    int r10_2 = (int32_t)ctx->cp2d[10];
    int r11_2 = (int32_t)ctx->cp2d[11];

    a3[0] = (r10_1 << 16) | (uint16_t)r9_0;
    a3[1] = (uint16_t)r10_0 | (r9_2 << 16);
    a3[2] = (r10_2 << 16) | (uint16_t)r11_1;
    a3[3] = (r11_0 << 16) | (uint16_t)r11_2;

    *(uint32_t*)((uint8_t*)a2 + 0x10) = ctx->cp2d[11];
