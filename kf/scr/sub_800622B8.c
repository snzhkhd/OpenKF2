...
void sub_800622B8(uint8_t* rdram, recomp_context* ctx) {
    ...
    // addiu       $s5, $s5, 0x60E4
    ctx->r21 = ADD32(ctx->r21, 0X60E4);
L_8006230C:
    // beq         $s1, $zero, L_80062370
    if (ctx->r17 == 0) {
        // addu        $s0, $zero, $zero
        ctx->r16 = ADD32(0, 0);
        goto L_80062370;
...
L_800623E0:
    ...
    ctx->r4 = S32(0X8001 << 16);
    // addiu       $a0, $a0, 0x361C
    ctx->r4 = ADD32(ctx->r4, 0X361C);
    // addu        $a1, $s0, $zero
    ctx->r5 = ADD32(ctx->r16, 0);
    // lui         $v0, 0x8007
    ctx->r2 = S32(0X8007 << 16);
    // lw          $v0, 0x6104($v0)
    ctx->r2 = MEM_W(0X6104, ctx->r2);
    // sll         $v1, $s0, 4
