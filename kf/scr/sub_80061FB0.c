...
L_80062040:
    ...
    // sh          $v1, 0x5074($at)
    MEM_H(0X5074, ctx->r1) = ctx->r3;
L_80062068:
    // bne         $s1, $zero, L_8006208C
    if (ctx->r17 != 0) {
        // ori         $v0, $zero, 0x4
        ctx->r2 = 0 | 0X4;
        goto L_8006208C;
