...
L_800310B8:
    ...
    ctx->r2 = 0 | 0X34;
    // srl         $fp, $t0, 24
    ctx->r30 = S32(U32(ctx->r8) >> 24);
    // andi        $v1, $fp, 0xFD
    ctx->r3 = ctx->r30 & 0XFD;
    // beq         $v1, $v0, L_8003127C
    if (ctx->r3 == ctx->r2) {
        // sw          $t0, 0x28($sp)
