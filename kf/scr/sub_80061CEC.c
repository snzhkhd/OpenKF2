...
L_80061D64:
    ...
    ctx->r3 = S32(0X8007 << 16);
    // lw          $v1, 0x60CC($v1)
    ctx->r3 = MEM_W(0X60CC, ctx->r3);
    // jal         0x80062268
    // sw          $v0, 0x14($v1)
    MEM_W(0X14, ctx->r3) = ctx->r2;
    sub_80062268(rdram, ctx);
    goto after_5;
    // sw          $v0, 0x14($v1)
    MEM_W(0X14, ctx->r3) = ctx->r2;
    after_5:
    ...
    // lw          $a0, 0x60CC($a0)
    ctx->r4 = MEM_W(0X60CC, ctx->r4);
    // jal         0x80062B20
    // sw          $v0, 0x4($a0)
    MEM_W(0X4, ctx->r4) = ctx->r2;
    sub_80062B20(rdram, ctx);
    goto after_6;
    // sw          $v0, 0x4($a0)
    MEM_W(0X4, ctx->r4) = ctx->r2;
    after_6:
